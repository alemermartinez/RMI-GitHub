...
margint.rob <- function(Xp, yp, point=NULL, windows, win.sigma=NULL, epsilon, 
                      sigma.hat=NULL, prob=NULL, max.it=20, k.h=1.345, k.t = 4.685, 
                      type='0', degree=NULL, qderivate=FALSE, typePhi='Huber', orderkernel=2,Qmeasure=NULL){
